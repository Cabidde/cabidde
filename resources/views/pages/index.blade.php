        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @foreach ($cidades as $cidade)
                    ...
                    <a href="{{ route('set.cidade', ['cidadeId' => $cidade->id]) }}" class="btn">
                        {{ $cidade->nome }}
                    </a>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
            <div class="container px-5">
                <a class="navbar-brand" href="#page-top">Cabidde</a>
        ...
        <header class="masthead text-center text-white">
            <div class="masthead-content">
                <div class="container px-5">
                    <h1 class="masthead-heading mb-0">As melhores lojas</h1>
                    <h2 class="masthead-subheading mb-0">Com entrega no mesmo dia*</h2>
                    <button type="button" class="btn btn-primary btn-xl rounded-pill mt-5" data-toggle="modal" data-target="#meuModal">
                        Selecionar Cidade
                    </button>
